...
public class HornetQConfiguration {
    ...
    public JmsTemplate jmsTemplate() throws Exception {
        JmsTemplate template = new JmsTemplate(hornetQConnectionFactory());
        template.setDeliveryPersistent(true);
        template.setMessageConverter(jaxbMessageConverter());
        template.setSessionTransacted(true);
        template.setSessionAcknowledgeModeName("SESSION_TRANSACTED");
